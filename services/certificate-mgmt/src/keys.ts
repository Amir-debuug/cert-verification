...
export namespace AppConstants {
  ...
  export const QR_SECRET = process.env.QR_SECRET;
  ...
  export const INVITE_SUBJECT =
    'Invited to sign a Certificate on Trust your Certificate';
...
export namespace ChannelServiceBindings {
  export const CHANNEL_SERVICE = BindingKey.create<ChannelManagementService>(
    'services.ChannelManagementService',
  );
}

export namespace CertificateServiceBindings {
  export const CERTIFICATE_SERVICE = BindingKey.create<CertificateService>(
    'services.certificate.service',
  );
}

export namespace VerificationServiceBindings {
  export const VERIFICATION_SERVICE = BindingKey.create<VerificationService>(
...
export namespace DataManagementServiceBindings {
  export const DATAMGMT_SERVICE = BindingKey.create<DataManagementService>(
    'services.datamanagement.service',
  );
}
